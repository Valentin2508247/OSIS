	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_LAB72, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LAB72));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.lpszMenuName = MAKEINTRESOURCE(IDC_LAB72);
...
void InitControls(HWND hWnd) {
	hEdit = CreateWindowEx(WS_EX_CLIENTEDGE, L"EDIT", L"Привет", WS_TABSTOP | WS_CHILD | WS_VISIBLE | ES_AUTOVSCROLL | ES_AUTOHSCROLL,
	...
	hButtonToRight = CreateWindow(L"BUTTON", L"В правый список", WS_TABSTOP | WS_CHILD | WS_VISIBLE,
		120, 260, 120, 30, hWnd, (HMENU)BUTTON_TORIGHT_ID, hInst, NULL);
