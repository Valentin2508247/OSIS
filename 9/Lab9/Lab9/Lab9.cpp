...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	bmp[0] = LoadImage(NULL, L"ghost0.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[1] = LoadImage(NULL, L"ghost1.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[2] = LoadImage(NULL, L"ghost2.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[3] = LoadImage(NULL, L"ghost3.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[4] = LoadImage(NULL, L"ghost4.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[5] = LoadImage(NULL, L"ghost5.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
	bmp[6] = LoadImage(NULL, L"ghost6.bmp", IMAGE_BITMAP, 16, 16, LR_LOADFROMFILE);
